package com.music.musicMS.config;
...
@OpenAPIDefinition(
        ...
        servers = {
                @Server(url = "${app.api.domain}", description = "Music API")})
